...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v8/issue"
...
| <code><a href="#@cdktf/provider-github.issue.IssueConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.25.0/docs/resources/issue#id Issue#id}. |
