...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v8/teamsettings"
...
&teamsettings.TeamSettingsConfig {
	...
	TeamId: *string,
	Id: *string,
	ReviewRequestDelegation: github.com/cdktf/cdktf-provider-github-go/github/v8.teamSettings.TeamSettingsReviewRequestDelegation,
}
```
...
| <code><a href="#@cdktf/provider-github.teamSettings.TeamSettingsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.24.0/docs/resources/team_settings#id TeamSettings#id}. |
