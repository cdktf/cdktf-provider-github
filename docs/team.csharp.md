...
| <code><a href="#@cdktf/provider-github.team.Team.property.parentTeamIdInput">ParentTeamIdInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-github.team.Team.property.parentTeamId">ParentTeamId</a></code> | <code>double</code> | *No description.* |
...
```csharp
public double ParentTeamIdInput { get; }
```
...
```csharp
public double ParentTeamId { get; }
```
...
| <code><a href="#@cdktf/provider-github.team.TeamConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.23.0/docs/resources/team#id Team#id}. |
...
| <code><a href="#@cdktf/provider-github.team.TeamConfig.property.parentTeamId">ParentTeamId</a></code> | <code>double</code> | The ID of the parent team, if this is a nested team. |
...
```csharp
public double ParentTeamId { get; set; }
```
