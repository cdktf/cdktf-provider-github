...
Refer to the Terraform Registory for docs: [`github_team_sync_group_mapping`](https://registry.terraform.io/providers/integrations/github/5.25.0/docs/resources/team_sync_group_mapping).
...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v8/teamsyncgroupmapping"
...
| <code><a href="#@cdktf/provider-github.teamSyncGroupMapping.TeamSyncGroupMappingConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.25.0/docs/resources/team_sync_group_mapping#id TeamSyncGroupMapping#id}. |
