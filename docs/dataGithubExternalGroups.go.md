...
Refer to the Terraform Registory for docs: [`data_github_external_groups`](https://registry.terraform.io/providers/integrations/github/5.25.0/docs/data-sources/external_groups).
...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v8/datagithubexternalgroups"
...
| <code><a href="#@cdktf/provider-github.dataGithubExternalGroups.DataGithubExternalGroupsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.25.0/docs/data-sources/external_groups#id DataGithubExternalGroups#id}. |
