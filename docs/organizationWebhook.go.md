...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v9/organizationwebhook"
...
&organizationwebhook.OrganizationWebhookConfig {
	...
	Events: *[]*string,
	Active: interface{},
	Configuration: github.com/cdktf/cdktf-provider-github-go/github/v9.organizationWebhook.OrganizationWebhookConfiguration,
	Id: *string,
	Name: *string,
}
```
