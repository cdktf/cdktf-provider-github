...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v6/organizationwebhook"
...
&organizationwebhook.OrganizationWebhookConfig {
	...
	Events: *[]*string,
	Active: interface{},
	Configuration: github.com/cdktf/cdktf-provider-github-go/github/v6.organizationWebhook.OrganizationWebhookConfiguration,
	Id: *string,
	Name: *string,
}
```
