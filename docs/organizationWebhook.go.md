...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v7/organizationwebhook"
...
&organizationwebhook.OrganizationWebhookConfig {
	...
	Events: *[]*string,
	Active: interface{},
	Configuration: github.com/cdktf/cdktf-provider-github-go/github/v7.organizationWebhook.OrganizationWebhookConfiguration,
	Id: *string,
	Name: *string,
}
```
