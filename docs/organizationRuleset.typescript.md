...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.organizationRuleset.OrganizationRulesetRulesMaxFileSize.property.maxFileSize">maxFileSize</a></code> | <code>number</code> | The maximum allowed size of a file in megabytes (MB). Valid range is 1-100 MB. |
