...
repositoryFile.RepositoryFile(
  ...
  file: str,
  repository: str,
  autocreate_branch: bool | IResolvable = None,
  ...
  id: str = None,
  overwrite_on_create: bool | IResolvable = None
)
```
...
| <code><a href="#@cdktf/provider-github.repositoryFile.RepositoryFile.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/repository_file#id RepositoryFile#id}. |
...
| <code><a href="#@cdktf/provider-github.repositoryFile.RepositoryFileConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/repository_file#id RepositoryFile#id}. |
