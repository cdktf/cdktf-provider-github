...
repositoryRuleset.RepositoryRuleset.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetConfig.property.repository">repository</a></code> | <code>string</code> | Name of the repository to apply ruleset to. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.9.0/docs/resources/repository_ruleset#id RepositoryRuleset#id}. |
...
```typescript
public readonly fileExtensionRestriction: RepositoryRulesetRulesFileExtensionRestriction;
```
...
```typescript
public readonly filePathRestriction: RepositoryRulesetRulesFilePathRestriction;
```
...
```typescript
public readonly maxFilePathLength: RepositoryRulesetRulesMaxFilePathLength;
```
...
```typescript
public readonly maxFileSize: RepositoryRulesetRulesMaxFileSize;
```
...
```typescript
public readonly mergeQueue: RepositoryRulesetRulesMergeQueue;
```
...
```typescript
public readonly requiredCodeScanning: RepositoryRulesetRulesRequiredCodeScanning;
```
...
const repositoryRulesetRulesFileExtensionRestriction: repositoryRuleset.RepositoryRulesetRulesFileExtensionRestriction = { ... }
```
...
const repositoryRulesetRulesFilePathRestriction: repositoryRuleset.RepositoryRulesetRulesFilePathRestriction = { ... }
```
...
const repositoryRulesetRulesMaxFilePathLength: repositoryRuleset.RepositoryRulesetRulesMaxFilePathLength = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFilePathLength.property.maxFilePathLength">maxFilePathLength</a></code> | <code>number</code> | The maximum allowed length of a file path. |
...
const repositoryRulesetRulesMaxFileSize: repositoryRuleset.RepositoryRulesetRulesMaxFileSize = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFileSize.property.maxFileSize">maxFileSize</a></code> | <code>number</code> | The maximum allowed size of a file in megabytes (MB). Valid range is 1-100 MB. |
...
const repositoryRulesetRulesMergeQueue: repositoryRuleset.RepositoryRulesetRulesMergeQueue = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueue.property.checkResponseTimeoutMinutes">checkResponseTimeoutMinutes</a></code> | <code>number</code> | Maximum time for a required status check to report a conclusion. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueue.property.maxEntriesToBuild">maxEntriesToBuild</a></code> | <code>number</code> | Limit the number of queued pull requests requesting checks and workflow runs at the same time. Defaults to `5`. |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueue.property.maxEntriesToMerge">maxEntriesToMerge</a></code> | <code>number</code> | The maximum number of PRs that will be merged together in a group. Defaults to `5`. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueue.property.minEntriesToMerge">minEntriesToMerge</a></code> | <code>number</code> | The minimum number of PRs that will be merged together in a group. Defaults to `1`. |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueue.property.minEntriesToMergeWaitMinutes">minEntriesToMergeWaitMinutes</a></code> | <code>number</code> | The time merge queue should wait after the first PR is added to the queue for the minimum group size to be met. |
...
```typescript
public readonly checkResponseTimeoutMinutes: number;
```
...
```typescript
public readonly groupingStrategy: string;
```
...
```typescript
public readonly maxEntriesToBuild: number;
```
...
```typescript
public readonly maxEntriesToMerge: number;
```
...
```typescript
public readonly minEntriesToMerge: number;
```
...
```typescript
public readonly minEntriesToMergeWaitMinutes: number;
```
...
const repositoryRulesetRulesRequiredCodeScanning: repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanning = { ... }
```
...
```typescript
public readonly requiredCodeScanningTool: IResolvable | RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool[];
```

- *Type:* cdktf.IResolvable | <a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool">RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool</a>[]
...
const repositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool: repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool = { ... }
```
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredStatusChecks.property.doNotEnforceOnCreate">doNotEnforceOnCreate</a></code> | <code>boolean \| cdktf.IResolvable</code> | Allow repositories and branches to be created if a check would otherwise prohibit it. |
...
new repositoryRuleset.RepositoryRulesetRulesFileExtensionRestrictionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesFileExtensionRestrictionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: RepositoryRulesetRulesFileExtensionRestriction;
```
...
new repositoryRuleset.RepositoryRulesetRulesFilePathRestrictionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesFilePathRestrictionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: RepositoryRulesetRulesFilePathRestriction;
```
...
new repositoryRuleset.RepositoryRulesetRulesMaxFilePathLengthOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFilePathLengthOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFilePathLengthOutputReference.property.maxFilePathLengthInput">maxFilePathLengthInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFilePathLengthOutputReference.property.maxFilePathLength">maxFilePathLength</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly internalValue: RepositoryRulesetRulesMaxFilePathLength;
```
...
new repositoryRuleset.RepositoryRulesetRulesMaxFileSizeOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFileSizeOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFileSizeOutputReference.property.maxFileSizeInput">maxFileSizeInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMaxFileSizeOutputReference.property.maxFileSize">maxFileSize</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly internalValue: RepositoryRulesetRulesMaxFileSize;
```
...
new repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public resetCheckResponseTimeoutMinutes(): void
```
...
```typescript
public resetGroupingStrategy(): void
```
...
```typescript
public resetMaxEntriesToBuild(): void
```
...
```typescript
public resetMaxEntriesToMerge(): void
```
...
```typescript
public resetMinEntriesToMerge(): void
```
...
```typescript
public resetMinEntriesToMergeWaitMinutes(): void
```
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.checkResponseTimeoutMinutesInput">checkResponseTimeoutMinutesInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.maxEntriesToBuildInput">maxEntriesToBuildInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.maxEntriesToMergeInput">maxEntriesToMergeInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.minEntriesToMergeInput">minEntriesToMergeInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.minEntriesToMergeWaitMinutesInput">minEntriesToMergeWaitMinutesInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.checkResponseTimeoutMinutes">checkResponseTimeoutMinutes</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.maxEntriesToBuild">maxEntriesToBuild</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.maxEntriesToMerge">maxEntriesToMerge</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.minEntriesToMerge">minEntriesToMerge</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesMergeQueueOutputReference.property.minEntriesToMergeWaitMinutes">minEntriesToMergeWaitMinutes</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly checkResponseTimeoutMinutesInput: number;
```
...
```typescript
public readonly groupingStrategyInput: string;
```
...
```typescript
public readonly maxEntriesToBuildInput: number;
```
...
```typescript
public readonly maxEntriesToMergeInput: number;
```
...
```typescript
public readonly minEntriesToMergeInput: number;
```
...
```typescript
public readonly minEntriesToMergeWaitMinutesInput: number;
```
...
```typescript
public readonly internalValue: RepositoryRulesetRulesMergeQueue;
```
...
```typescript
public putFileExtensionRestriction(value: RepositoryRulesetRulesFileExtensionRestriction): void
```
...
```typescript
public putFilePathRestriction(value: RepositoryRulesetRulesFilePathRestriction): void
```
...
```typescript
public putMaxFilePathLength(value: RepositoryRulesetRulesMaxFilePathLength): void
```
...
```typescript
public putMaxFileSize(value: RepositoryRulesetRulesMaxFileSize): void
```
...
```typescript
public putMergeQueue(value: RepositoryRulesetRulesMergeQueue): void
```
...
```typescript
public putRequiredCodeScanning(value: RepositoryRulesetRulesRequiredCodeScanning): void
```
...
```typescript
public readonly fileExtensionRestriction: RepositoryRulesetRulesFileExtensionRestrictionOutputReference;
```
...
```typescript
public readonly filePathRestriction: RepositoryRulesetRulesFilePathRestrictionOutputReference;
```
...
```typescript
public readonly maxFilePathLength: RepositoryRulesetRulesMaxFilePathLengthOutputReference;
```
...
```typescript
public readonly maxFileSize: RepositoryRulesetRulesMaxFileSizeOutputReference;
```
...
```typescript
public readonly mergeQueue: RepositoryRulesetRulesMergeQueueOutputReference;
```
...
```typescript
public readonly requiredCodeScanning: RepositoryRulesetRulesRequiredCodeScanningOutputReference;
```
...
```typescript
public readonly fileExtensionRestrictionInput: RepositoryRulesetRulesFileExtensionRestriction;
```
...
```typescript
public readonly filePathRestrictionInput: RepositoryRulesetRulesFilePathRestriction;
```
...
```typescript
public readonly maxFilePathLengthInput: RepositoryRulesetRulesMaxFilePathLength;
```
...
```typescript
public readonly maxFileSizeInput: RepositoryRulesetRulesMaxFileSize;
```
...
```typescript
public readonly mergeQueueInput: RepositoryRulesetRulesMergeQueue;
```
...
```typescript
public readonly requiredCodeScanningInput: RepositoryRulesetRulesRequiredCodeScanning;
```
...
new repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putRequiredCodeScanningTool(value: IResolvable | RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool[]): void
```
...
```typescript
public readonly requiredCodeScanningTool: RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolList;
```
...
```typescript
public readonly requiredCodeScanningToolInput: IResolvable | RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool[];
```
...
```typescript
public readonly internalValue: RepositoryRulesetRulesRequiredCodeScanning;
```
...
new repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool[];
```
...
new repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredStatusChecksOutputReference.property.doNotEnforceOnCreateInput">doNotEnforceOnCreateInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-github.repositoryRuleset.RepositoryRulesetRulesRequiredStatusChecksOutputReference.property.doNotEnforceOnCreate">doNotEnforceOnCreate</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
