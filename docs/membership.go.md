...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v8/membership"
...
| <code><a href="#@cdktf/provider-github.membership.MembershipConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.26.0/docs/resources/membership#id Membership#id}. |
