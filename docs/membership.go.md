...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v14/membership"
...
| <code><a href="#@cdktf/provider-github.membership.MembershipConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.1.0/docs/resources/membership#id Membership#id}. |
