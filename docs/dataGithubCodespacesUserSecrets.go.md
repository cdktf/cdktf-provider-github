...
Refer to the Terraform Registory for docs: [`data_github_codespaces_user_secrets`](https://registry.terraform.io/providers/integrations/github/5.31.0/docs/data-sources/codespaces_user_secrets).
...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v10/datagithubcodespacesusersecrets"
...
| <code><a href="#@cdktf/provider-github.dataGithubCodespacesUserSecrets.DataGithubCodespacesUserSecretsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.31.0/docs/data-sources/codespaces_user_secrets#id DataGithubCodespacesUserSecrets#id}. |
