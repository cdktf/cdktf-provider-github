...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v7/repositorywebhook"
...
&repositorywebhook.RepositoryWebhookConfig {
	...
	Repository: *string,
	Active: interface{},
	Configuration: github.com/cdktf/cdktf-provider-github-go/github/v7.repositoryWebhook.RepositoryWebhookConfiguration,
	Id: *string,
	Name: *string,
}
```
