...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v9/repositorywebhook"
...
&repositorywebhook.RepositoryWebhookConfig {
	...
	Repository: *string,
	Active: interface{},
	Configuration: github.com/cdktf/cdktf-provider-github-go/github/v9.repositoryWebhook.RepositoryWebhookConfiguration,
	Id: *string,
	Name: *string,
}
```
