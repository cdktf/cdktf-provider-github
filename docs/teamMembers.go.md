...
```go
import "github.com/cdktf/cdktf-provider-github-go/github/v14/teammembers"
...
| <code><a href="#@cdktf/provider-github.teamMembers.TeamMembersConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.3.1/docs/resources/team_members#id TeamMembers#id}. |
