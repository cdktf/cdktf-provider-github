// https://registry.terraform.io/providers/integrations/github/6.0.1/docs/resources/enterprise_organization
...
export class EnterpriseOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnterpriseOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.0.1/docs/resources/enterprise_organization#import import section} in the documentation of this resource for the id to use
