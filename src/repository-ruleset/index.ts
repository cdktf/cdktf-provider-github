// https://registry.terraform.io/providers/integrations/github/5.40.0/docs/resources/repository_ruleset
...
export class RepositoryRulesetRulesRequiredDeploymentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // required_deployment_environments - computed: false, optional: true, required: false
  ...
  public resetRequiredDeploymentEnvironments() {
    this._requiredDeploymentEnvironments = undefined;
  }
  // Temporarily expose input value. Use with caution.
