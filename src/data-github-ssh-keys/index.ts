...
// https://registry.terraform.io/providers/integrations/github/6.2.3/docs/data-sources/ssh_keys
...
export class DataGithubSshKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubSshKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.2.3/docs/data-sources/ssh_keys#import import section} in the documentation of this resource for the id to use
