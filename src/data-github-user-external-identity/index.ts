...
// https://registry.terraform.io/providers/integrations/github/6.2.3/docs/data-sources/user_external_identity
...
export class DataGithubUserExternalIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubUserExternalIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.2.3/docs/data-sources/user_external_identity#import import section} in the documentation of this resource for the id to use
