...
// https://registry.terraform.io/providers/integrations/github/6.3.1/docs/resources/repository_tag_protection
...
export class RepositoryTagProtection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryTagProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.3.1/docs/resources/repository_tag_protection#import import section} in the documentation of this resource for the id to use
