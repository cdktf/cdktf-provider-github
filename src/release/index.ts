...
// https://registry.terraform.io/providers/integrations/github/6.0.0/docs/resources/release
...
export class Release extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Release that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.0.0/docs/resources/release#import import section} in the documentation of this resource for the id to use
