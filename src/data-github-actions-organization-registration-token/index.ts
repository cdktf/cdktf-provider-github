...
// https://registry.terraform.io/providers/integrations/github/6.8.0/docs/data-sources/actions_organization_registration_token
...
export class DataGithubActionsOrganizationRegistrationToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubActionsOrganizationRegistrationToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.0/docs/data-sources/actions_organization_registration_token#import import section} in the documentation of this resource for the id to use
