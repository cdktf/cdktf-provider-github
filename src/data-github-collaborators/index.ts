...
// https://registry.terraform.io/providers/integrations/github/6.8.0/docs/data-sources/collaborators
...
export class DataGithubCollaborators extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubCollaborators that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.0/docs/data-sources/collaborators#import import section} in the documentation of this resource for the id to use
