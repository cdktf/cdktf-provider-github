...
// https://registry.terraform.io/providers/integrations/github/6.8.0/docs/data-sources/repository_webhooks
...
export class DataGithubRepositoryWebhooks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubRepositoryWebhooks that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.0/docs/data-sources/repository_webhooks#import import section} in the documentation of this resource for the id to use
