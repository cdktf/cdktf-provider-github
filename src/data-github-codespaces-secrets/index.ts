// https://registry.terraform.io/providers/integrations/github/5.42.0/docs/data-sources/codespaces_secrets
...
export class DataGithubCodespacesSecrets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubCodespacesSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/5.42.0/docs/data-sources/codespaces_secrets#import import section} in the documentation of this resource for the id to use
