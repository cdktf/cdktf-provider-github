...
// https://registry.terraform.io/providers/integrations/github/5.41.0/docs/data-sources/repository_teams
...
export class DataGithubRepositoryTeams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubRepositoryTeams that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/5.41.0/docs/data-sources/repository_teams#import import section} in the documentation of this resource for the id to use
